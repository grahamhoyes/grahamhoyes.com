...
In my free time, I enjoy starting web development projects (and sometimes even finishing them), playing the saxophone and [EWI](https://www.youtube.com/watch?v=HYie77YHkns), tweaking my [Dvorak-based keyboard layout](https://github.com/grahamhoyes/qmk_firmware/blob/grahamhoyes/keyboards/aleblazer/zodiark/keymaps/grahamhoyes/keymap.c), [homelabbing](https://github.com/grahamhoyes/homelab), and CAD / 3D printing.
